  ...
  return (
    <nav className="sm:container sm:mx-auto">
      ...
      <div className="z-10 block max-w-screen-lg py-6 sm:flex sm:items-center sm:justify-between xl:max-w-screen-xl">
        ...
        >
          <div className="mb-2 block text-left text-lg text-primary-dark hover:text-secondary-dark dark:text-ternary-light sm:mx-4 sm:py-2 dark:hover:text-secondary-light">
            <Link href={"/projects"} aria-label={"Projects"}>
              Projects
            </Link>
          </div>
          <div className="mb-2 block border-t-2 pt-3 text-left text-lg text-primary-dark border-primary-light hover:text-secondary-dark dark:text-ternary-light dark:border-secondary-dark sm:mx-4 sm:border-t-0 sm:py-2 sm:pt-2 dark:hover:text-secondary-light">
          ...
          <div className="border-t-2 pt-3 border-primary-light dark:border-secondary-dark sm:border-t-0 sm:pt-0">
            <button
        ...
        <div className="m-0 mt-5 hidden items-center justify-center p-5 shadow-lg font-general-medium sm:mt-3 sm:ml-4 sm:flex sm:p-0 sm:shadow-none">
          <div
